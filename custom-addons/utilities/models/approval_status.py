...
class ApprovalStatusHello(models.Model):
    ...
    def create(self, vals_list):
        result = super(ApprovalStatusHello, self).create(vals_list)
        return result
    ...
    def write(self, vals):
        ...
        result = super(ApprovalStatusHello, self).write(vals)
    ...
    def unlink(self):
        return super(ApprovalStatusHello, self).unlink()
