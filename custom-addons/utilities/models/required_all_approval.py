...
class RequiredAllApproval(models.Model):
    ...
    def implement_approval_flow(self):
        self.ensure_one()
        self.this_all_approval_group_id.implement_approval_flow()

    def not_implement_approval_flow(self):
        self.ensure_one()
        self.this_all_approval_group_id.not_implement_approval_flow()

    def _create_this_all_approval_group(self, and_implement=False):
        self.ensure_one()
