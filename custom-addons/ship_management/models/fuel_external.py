...
class FuelExternalReceiving(models.Model):
    ...
    _description = "Fuel External Receiving"
    ...
    fuel_check_ids = fields.One2many(
        "ship.fuel.external.check", "fuel_external_receiving_id", string="Fuel Checks"
    )
    ...
    def _get_bunkering_safety_checklist_html(self):
        ...
        variable_name = CONST_UTILITIES.HTML_FUEL_EXTERNAL_BUNKERING_SAFETY_CHECKLIST
    ...
    def _get_default_fuel_checks(self):
        default_value_model = self._get_default_value_model()
        variable_name = CONST_UTILITIES.RELATION_FUEL_EXTERNAL_FUEL_CHECKS
        return default_value_model._get_default_value_by_variable_name(variable_name)
    ...
    def _create_default_fuel_checks(self):
        ...
        self.env["ship.fuel.external.check"].create(
            [
                {
                    "name": check.field_1,
                    "check_type": check.field_2,
                    "fuel_external_receiving_id": self.id,
                }
